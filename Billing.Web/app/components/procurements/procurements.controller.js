        ...
        .controller('ProcurementsController', ['$scope', '$http', '$uibModal', 'DataFactory', 'ToasterService', 'ProcurementsFactory', function ($scope, $http, $uibModal, DataFactory, ToasterService, ProcurementsFactory) {
            ...
            $scope.new = function () {
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: 'app/view/procurements/new.html',
            ...
            $scope.show = function (procurement) {
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    templateUrl: 'app/view/procurements/show.html',
                    controller: 'ModalInstanceController',
                    controllerAs: '$modal',
                    resolve: {
                        data: function () {
            ...
            $scope.edit = function (procurement) {
                ...
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    templateUrl: 'app/view/procurements/edit.html',
                    controller: 'ModalInstanceController',
                    controllerAs: '$modal',
                    resolve: {
                        data: function () {
            ...
            $scope.delete = function (procurement) {
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    templateUrl: 'app/view/procurements/delete.html',
                    controller: 'ModalInstanceController',
                    controllerAs: '$modal',
                    resolve: {
                        data: function () {
