        ...
        .controller('CustomersController', ['$scope', '$http', '$uibModal', 'DataFactory', 'ToasterService', 'CustomersFactory', function ($scope, $http, $uibModal, DataFactory, ToasterService, CustomersFactory) {
            ...
            $scope.new = function () {
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: 'app/view/customers/new.html',
            ...
            $scope.show = function (customer) {
                ...
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    templateUrl: 'app/view/customers/show.html',
                    controller: 'ModalInstanceController',
                    controllerAs: '$modal',
                    resolve: {
                        data: function () {
            ...
            $scope.edit = function (customer) {
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    templateUrl: 'app/view/customers/edit.html',
                    controller: 'ModalInstanceController',
                    controllerAs: '$modal',
                    resolve: {
                        data: function () {
            ...
            $scope.delete = function (customer) {
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    templateUrl: 'app/view/customers/delete.html',
                    controller: 'ModalInstanceController',
                    controllerAs: '$modal',
                    resolve: {
                        data: function () {
